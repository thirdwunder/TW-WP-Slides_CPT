...
class TW_Slides_Plugin_Settings {

	/**
	 * The single instance of TW_Slides_Plugin_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'tw-slides-plugin' ) . '</a>';
...
/*
		$settings['extra'] = array(
			...
			'fields'				=> array(
				array(
					'id' 			=> 'number_field',
					'label'			=> __( 'A Number' , 'tw-slides-plugin' ),
					'description'	=> __( 'This is a standard number field - if this field contains anything other than numbers then the form will not be submitted.', 'tw-slides-plugin' ),
					'type'			=> 'number',
					'default'		=> '',
					'placeholder'	=> __( '42', 'tw-slides-plugin' )
				),
				array(
					'id' 			=> 'colour_picker',
					'label'			=> __( 'Pick a colour', 'tw-slides-plugin' ),
					'description'	=> __( 'This uses WordPress\' built-in colour picker - the option is stored as the colour\'s hex code.', 'tw-slides-plugin' ),
					'type'			=> 'color',
					'default'		=> '#21759B'
				),
				array(
					'id' 			=> 'an_image',
					'label'			=> __( 'An Image' , 'tw-slides-plugin' ),
					'description'	=> __( 'This will upload an image to your media library and store the attachment ID in the option field. Once you have uploaded an imge the thumbnail will display above these buttons.', 'tw-slides-plugin' ),
					'type'			=> 'image',
					'default'		=> '',
					'placeholder'	=> ''
				),
				array(
					'id' 			=> 'multi_select_box',
					'label'			=> __( 'A Multi-Select Box', 'tw-slides-plugin' ),
					'description'	=> __( 'A standard multi-select box - the saved data is stored as an array.', 'tw-slides-plugin' ),
					'type'			=> 'select_multi',
...
*/
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'tw-slides-plugin' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
	...
	/**
	 * Main TW_Slides_Plugin_Settings Instance
	 *
	 * Ensures only one instance of TW_Slides_Plugin_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see TW_Slides_Plugin()
	 * @return Main TW_Slides_Plugin_Settings instance
	 */
